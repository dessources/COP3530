...
public class Main {
    ...
    public Main() {
        ...
        Dictionary dictionary = new Dictionary("/workspaces/COP3530/Assignment 3/shuffled dictionary.txt");

        // File file = new File("assignment 3 test set.txt");
        File file = new File("/workspaces/COP3530/Assignment 3/assignment 3 test set.txt");
